...
#  QT3_QT3_LIBRARY, where to find the Qt library.
...
IF(QT3_QT3_LIBRARY)
ELSE(QT3_QT3_LIBRARY)
ENDIF(QT3_QT3_LIBRARY)
...
IF(QT3_FOUND)
  SET( QT3_LIBRARIES ${QT3_LIBRARIES} ${QT3_QT3_LIBRARY} )
  SET( QT3_DEFINITIONS "")
  ...
  IF (WIN32 AND NOT CYGWIN)
    IF (QT3_QTMAIN_LIBRARY)
      ...
      SET (QT3_LIBRARIES imm32.lib ${QT3_QT3_LIBRARY} ${QT3_QTMAIN_LIBRARY} )
      SET (QT3_LIBRARIES ${QT3_LIBRARIES} winmm wsock32)
    ELSE (QT3_QTMAIN_LIBRARY)
      # for version 2
      SET (QT3_LIBRARIES imm32.lib ws2_32.lib ${QT3_QT3_LIBRARY} )
    ENDIF (QT3_QTMAIN_LIBRARY)
  ELSE (WIN32 AND NOT CYGWIN)
    SET (QT3_LIBRARIES ${QT3_QT3_LIBRARY} )
    
    SET (QT3_DEFINITIONS -DQT_SHARED -DQT_NO_DEBUG)
    IF(QT3_QT3_LIBRARY MATCHES "qt-mt")
      SET (QT3_DEFINITIONS ${QT3_DEFINITIONS} -DQT_THREAD_SUPPORT -D_REENTRANT)
    ENDIF(QT3_QT3_LIBRARY MATCHES "qt-mt")
  ...
  MACRO (QT3_GET_MOC_INC_DIRS _moc3_INC_DIRS)
     SET(${_moc3_INC_DIRS})
     GET_DIRECTORY_PROPERTY(_inc_DIRS INCLUDE_DIRECTORIES)

     FOREACH(_current ${_inc_DIRS})
        SET(${_moc3_INC_DIRS} ${${_moc3_INC_DIRS}} "-I" ${_current})
     ENDFOREACH(_current ${_inc_DIRS})
  ENDMACRO(QT3_GET_MOC_INC_DIRS)

  MACRO (QT3_WRAP_CPP outfiles )
    # get include dirs
    QT3_GET_MOC_INC_DIRS(moc3_includes)

    FOREACH (it ${ARGN})
      GET_FILENAME_COMPONENT(it ${it} ABSOLUTE)
      GET_FILENAME_COMPONENT(outfile ${it} NAME_WE)

      SET(outfile ${CMAKE_CURRENT_BINARY_DIR}/moc3_${outfile}.cxx)
